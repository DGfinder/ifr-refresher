...
The app now serves these 51 source topics through a single contents-and-reader flow at `/study`. Each topic offers its exact captured text and original page images. Tables and diagrams open in original-page view where extraction loses their layout. No operational context has been added. Three isolated brand mockups at `/design-system` compare the same reader content.
